...
module.exports = {
  ...
  let m = await message.channel.send("Szukam Tekstu")  
...
.then(results => {
    ...
    .then(lyrics => {
      if (lyrics.length > 4095) {
        return message.channel.send("Tekst jest za długi!")
      }
...
}).catch(err => message.channel.send("Nie udało się znaleźć tesktu!"));
